...
public class Runner {
    ...
    public static void main(String[] args) {
        try {
            final String root = "C:/Users/Igor_Tseluiko/Desktop/git/PdfTester/src/main/resources/";
            File xml = new File(root + "templates/data.xml");
            File xslt = new File(root + "templates/template.xsl");
            File pdffile = new File("C:/Users/Igor_Tseluiko/Desktop/git/PdfTester/src/Tseluiko_CV.pdf");
